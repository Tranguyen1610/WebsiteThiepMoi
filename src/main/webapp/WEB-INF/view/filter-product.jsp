	...
	<div class="container">
		...
		<div class="list-products grid">
			<div class="row">
				...
				<c:forEach items="${LoaiThiep.listThiep}" var="tempThiep">
					...
					<div class="col-3">
						<div class="product-item">
							<div class="product-item-img">
								<img src="${tempThiep.hinhAnh}" alt="anhthiep"> <a
									href="${detailUrl}" class="product-link">XEM CHI TIẾT</a>
							</div>
							...
							<div class="product-item-btn">
								...
								<c:if test="${tempThiep.soLuongTon!='0'}">
									<security:authorize access="hasAnyRole('ROLE_KH','ROLE_NV')">
										<c:if test="${param.error == null}">
											<a href="${paymentUrl}" class="product-item-add-card styleA">Mua
												ngay</a>
										</c:if>
									</security:authorize>
									<security:authorize access="!hasAnyRole('ROLE_KH','ROLE_NV')">
										<a class="product-item-add-card styleA" onclick="login()">Mua
											ngay</a>
									</security:authorize>
								</c:if>
							</div>
