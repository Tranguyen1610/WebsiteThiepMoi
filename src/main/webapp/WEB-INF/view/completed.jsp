...
<body>
	...
	<div class="article" style="text-align: center;">
			<img src="${pageContext.request.contextPath}/resources/img/checkout.png"alt="icon" class="img_out""> 
			<h1 >BẠN ĐÃ ĐẶT ĐƠN HÀNG THÀNH CÔNG</h1>
			<h3>Vui lòng đợi xác nhận trong thời gian sớm nhất.Cảm ơn quý khách đã mua sắm tại Thiệp cưới cao cấp FOREVER</h3>
			<a href="${listHDUrl}" class="btn-dh">Xem đơn hàng bạn đã đặt</a>
