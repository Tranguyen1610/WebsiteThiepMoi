...
<body>
		...
		<div class="header__bottom">
			<div class="grid navbar">
				...
				<ul class="navbar-list">
					...
					<li class="navbar-item wedding"><a href="${listFilterUrlOne}">Thiệp
							cưới </a></li>
					<li class="navbar-item event"><a href="${listFilterUrlTwo}">Thiệp
							sự kiện </a></li>
					<li class="navbar-item"><a
						href="${pageContext.request.contextPath}/showQ&A">Hỏi đáp</a></li>
					<li class="navbar-item"><a
						href="${pageContext.request.contextPath}/showTrendPage">Xu
							hướng</a></li>
					<li class="navbar-item"><a
						href="${pageContext.request.contextPath}/showcontact">Liên hệ</a></li>
				</ul>
			</div>
		</div>
	</header>
	...
	<div class="wrapper">
		<div class="product-img">
			<img src="${Thiep.hinhAnh}" height="600" width="500">
		</div>
		<div class="product-info">
			<div class="product-text">
				<h1>${Thiep.tenThiep}</h1>
				<div class="line"></div>
				<h3>Mô tả</h3>
				<p>${Thiep.moTa}</p>
				<div class="line"></div>
				<div class="product">
					<span>Giá bán:</span> &ensp; <span>${Thiep.giaTien}</span><span>đ</span>
				</div>
				<br>
				<p>
					<span>Số lượng:</span>&emsp;${Thiep.soLuongTon}
				</p>
				<br>
			</div>
			<c:url var="paymentUrl" value="/product/showPayment">
				<c:param name="productId" value="${Thiep.maThiep}" />
			</c:url>
			<div class="product-price-btn">
				<c:if test="${Thiep.soLuongTon=='0'}">
					<div class="quantity-zero-detail">Hết hàng</div>
				</c:if>
				<c:if test="${Thiep.soLuongTon!='0'}">
					<security:authorize access="hasAnyRole('ROLE_KH','ROLE_NV')">
						<c:if test="${param.error == null}">
							<a href="${paymentUrl}" class="styleAA styleA">Mua ngay</a>
						</c:if>
					</security:authorize>
					<security:authorize access="!hasAnyRole('ROLE_KH','ROLE_NV')">
						<a class="styleAA styleA" onclick="login()">Mua ngay</a>
					</security:authorize>
				</c:if>
